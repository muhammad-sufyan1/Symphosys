...
export function AmbientBackground() {
  return (
    <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden will-change-transform" aria-hidden>
      ...
      <div
        className="absolute -top-[18vh] -left-[12vw] w-[48vw] h-[48vw] max-w-[640px] max-h-[640px] rounded-full blur-[60px] opacity-60"
        style={{
          background:
      ...
      />
      <div
        className="absolute -bottom-[22vh] -right-[16vw] w-[50vw] h-[50vw] max-w-[640px] max-h-[640px] rounded-full blur-[70px] opacity-55"
        style={{
          background:
      ...
      />
      <div
        className="absolute top-[36vh] left-[30vw] w-[30vw] h-[30vw] max-w-[380px] max-h-[380px] rounded-full blur-[50px] opacity-55"
        style={{
          background:
